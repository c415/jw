				...
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
							...
							<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="/admin/selectCourse" id="form1" method="get">
								<div class="input-group">
									<input type="text" value="${value}" class="form-control" placeholder="请输入课程名称" name="findByName">
